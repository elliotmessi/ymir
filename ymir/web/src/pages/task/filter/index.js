  ...
  return (
    <div className={commonStyles.wrapper}>
      ...
      <Card className={commonStyles.container} title={t('task.fusion.header.filter')}>
        <Form form={form} name="fusionForm" {...formLayout} onFinish={onFinish} onFinishFailed={onFinishFailed}>
          <MergeType form={form} />
          ...
          <Form.Item label={t('task.fusion.form.exclude.label')} tooltip={t('tip.task.fusion.excludelable')} name="excludes">
